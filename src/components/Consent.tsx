    ...
    return (
        <>
            <Dialog
                ...
                dir={"rtl"}
            >
                <DialogTitle sx={{"font-size": "1.5rem"}}>
                    {"ברוכים הבאים ל־Movie Time!"}
                </DialogTitle>
                <DialogContent>
                    <DialogContentText>כאן תוכלו למצוא בקלות ובמהירות את כל הסרטים וההקרנות בבתי הקולנוע המובילים בארץ במקום אחד.
                        <br/>
                        בחרו תאריך, סיננו לפי סרט או רשת קולנוע, ובחרו את ההקרנה שמתאימה לכם.
                        <br/>
                        לבסוף לחיצה על ההקרנה תוביל אתכם ישירות לאתר בית הקולנוע לרכישת כרטיסים.
                        <br/>
                        <br/>
                        תהנו מהסרט!
                    </DialogContentText>
                ...
                <DialogContent>
                    <DialogContentText fontSize={"0.6rem"}>
